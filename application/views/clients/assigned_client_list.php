                    ...
                    <td>
                      <?php if($client['is_active'] == 1): ?>
                        ...
                        <?php if(($this->session->userdata['role'] == 'super_admin') || ($this->session->userdata['role'] == 'admin')):?>
                          <a class="btn btn-danger btn-xs" href=<?php echo base_url("Client/toggleActive/".$client['id']) ?>>Deactivate</a>
                        <?php endif;?>
                      <?php else:?>
                        <?php if(($this->session->userdata['role'] == 'super_admin') || ($this->session->userdata['role'] == 'admin')):?>
                          <a class="btn btn-success btn-xs" href=<?php echo base_url("Client/toggleActive/".$client['id']) ?>>Activate</a> <br>
                        <?php endif;?>
